...
if __name__ == '__main__':
    workbook = xlsxwriter.Workbook('features_'+PATH+'.xlsx')
    worksheet = workbook.add_worksheet('Libro1')
    ...
    for i in range(maxImg):
        ...
        featuresArray = [labels[i], A , upperCount, lowerCount, leftCount,
        ...
        for f in range(len(featuresArray)):
            feature = featuresArray[f]
            worksheet.write(i, f , feature)
##        cv2.imshow('img',img)
